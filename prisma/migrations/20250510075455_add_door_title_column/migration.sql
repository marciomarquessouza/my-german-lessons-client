...
INSERT INTO "new_lessons" ("challengesQnt", "description", "floorPosition", "id", "name", "roomPosition", "slugName") SELECT "challengesQnt", "description", "floorPosition", "id", "name", "roomPosition", "slugName" FROM "lessons";
DROP TABLE "lessons";
